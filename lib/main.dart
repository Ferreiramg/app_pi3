      ...
      body: Center(
        child: Container(
          ...
          child: GridView.count(
            ...
            crossAxisCount: 2,
            children: [
              _Card(context, Colors.teal, Text('Notas')),
              _Card(context, Colors.cyan, Text('Cursos')),
              _Card(context, Colors.deepOrange, Text('Bolsas')),
              _Card(context, Colors.purpleAccent, Text('Diciplinas'))
            ],
          ),
        ),
      ),
            ...
            child: Align(
                ...
                child: Container(
                  ...
                  children: <Widget>[
                    ...
                    ListTile(leading: Icon(Icons.help), title: Text('Help and Feedback')),
                    ListTile(
                        title: Text('Logout'),
...
Widget _Card(BuildContext context, color, Text title) {
  return Center(
    child: Card(
      child: InkWell(
        splashColor: color,
        ...
        child: const SizedBox(
          width: 300,
          height: 100,
          child: Text("Tenho que pegar no parametro"),
        ),
      ),
    ),
  );
